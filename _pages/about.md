...
I am a first-year PhD candidate at the HKUST NLP Group, Hong Kong University of Science and Technology (HKUST), supervised by Professor Junxian He. I received my B.Eng. from Shanghai Jiao Tong University (SJTU) in June 2024, where I was also advised by Professor Junxian He during my undergraduate studies.
...
2. **On the Perception Bottleneck of VLMs for Chart Understanding.** **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. *Arxiv*, 2025. (Code: Vision4Chart)

3. **On the Universal Truthfulness Hyperplane Inside LLMs.** **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. *EMNLP 2024*. (Code: Universal_Truthfulness_Hyperplane)
